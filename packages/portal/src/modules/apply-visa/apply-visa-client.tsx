  ...
  return (
    <Card
      className={cn(
        ...
        selected
          ? "ring-primary scale-100 shadow-sm ring-2"
          : "scale-95",
      )}
            ...
            <section className="overflow-hidden rounded-lg border bg-card shadow-sm">
              ...
              >
                ...
                {shouldShowToggle && !showAllDocs ? (
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 flex justify-center bg-gradient-to-t from-white to-transparent px-4 pb-3 pt-14">
                    <button
              ...
              {shouldShowToggle && showAllDocs ? (
                <div className="flex justify-center px-4 pb-3">
                  <button
                    className="flex h-8 items-center gap-2 rounded-lg border bg-background px-3 text-sm shadow-sm hover:bg-muted"
